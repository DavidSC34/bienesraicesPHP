    ...
    <div class="contenedor-anuncios">
        <div class="anuncio">
            ...
            <div class="contenido-anuncio">
                ...
                <p>Casa en el Lago con excelete vista, acabados de lujo a un excelente precio</p>
...
<section class="imagen-contacto">
    ...
    <p>Llea el formulario de contacto y un asesor se pondra en contacto contigo a la brevedad</p>
...
<div class="contenedor seccion seccion-inferior">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p class="informacion-meta">Escrito el: <span>20/10/2021</span> por : <span>Admin</span> </p>
                    <p>
                        Maximiza el espacio en tu hogar con esta guiam aprende a combinar muebles y colores para darle vida a tu espacio
                    </p>
                </a>
            </div>
        </article>
    ...
    <section class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>
                El personal se comportó de una excelente forma, muy buena atención y la cas que me ofrecieron cumple con todas mis expectativas
            </blockquote>
            <p>- David Sanchez</p>
        </div>
    </section>
